...
The red line indicates the capacity needed to basecall 1 PromethION flowcell (yielding 150 Gbp/72hours) with the SUPer accuracy model, the blue line 2 flowcells.
...
dw_specs %>% 
  ...
  ylab("SUP basecalling performance\n(Gbp/day)")+
  geom_bar(stat="identity")+
  geom_text(aes(y=(`Gbp/day`+10)))+
...
dw_specs %>% filter(!is.na(`Release price or some webshop price (USD)`)) %>%
  ...
  geom_bar(stat="identity")+
  geom_text(aes(y=(`PricePerformance`*1.6)))+
  scale_y_log10()+
