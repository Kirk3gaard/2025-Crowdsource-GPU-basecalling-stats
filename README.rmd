...
library(gsheet)
library(scales)
d<-gsheet2tbl('https://docs.google.com/spreadsheets/d/1p_oqalXtyMomcoeh0CE-crBgxsGifBYMvTR7hHBqmEw/edit?usp=sharing') %>% group_by(GPU) %>% filter(`Gbp/day`==max(`Gbp/day`))
